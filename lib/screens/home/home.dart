  ...
  Widget build(BuildContext context) {
    ...
    Future handleSubmit() async {
      ...
      if (teacher != null) {
        ...
        await postNearbyBeaconScanDetails(
            {"year": _year, "dept": _dept, "sec": _sec});
        await postNearbyDevices(
            nearby, {"year": _year, "dept": _dept, "sec": _sec});
                      ...
                      child: Wrap(
                        ...
                        children: [
                          ...
                          DropdownButton(
                            value: sec,
                            items:
                                sections.map((e) => toDropDownItem(e)).toList(),
                            onChanged: (val) {
                              if (val != null) {
                                sec = val;
                                print(val);
